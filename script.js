...
// to track whether a timer is currently active
...
function createTimer(totalSeconds) {
    ...
    function updateTimerDisplay() {
        ...
        if (totalSeconds <= 0) {
            ...
            timerElement.textContent = timeFormatter(totalSeconds);
        }
    }
...
function playAudioAlert() {
    const audio = new Audio('./victory_sms.mp3'); // Replace with the path to your audio file
    audio.play();
}